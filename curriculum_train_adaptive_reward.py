...
from wrappers.adaptive_reward import AdaptiveRewardCurriculumWrapper
...
def make_env():
    ...
    env = Monitor(env)
    env = AdaptiveRewardCurriculumWrapper(env)
    return env
...
def train_adaptive():
    ...
    model.save("models/ppo_lunar_lander_adaptive_reward")
    print("\nTraining complete!")
